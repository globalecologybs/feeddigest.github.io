...
In this digest, marine and coastal ecology features prominently, with [seagrass mass flowering](#post-2) linked to Mediterranean heatwaves, [invasive seaweed functional compensation](#post-7) under warming, and a [marine ecosystem ecology review](#post-13) synthesising recent advances. Terrestrial themes span [tree diversity and soil carbon](#post-11) stabilisation via microbial pathways, [alpine shrubification](#post-29) documented through the GLORIA network, and [European grassland plant strategies](#post-6) under climate change. Biodiversity policy and governance appear in discussions of [aquatic eDNA targets](#post-1), [Antarctic disaster management](#post-8), [biological invasion response](#post-5), and [AI in conservation science](#post-14). Macroecological theory is represented by work on [metawebs as modelling frameworks](#post-9), [functional diversity scaling laws](#post-23), [bumblebee phylogenomics](#post-12), and [animal home range scaling](#post-27). Soil microbiome contributions address [bacterial and fungal ecosystem health indicators](#post-30) and [chemodiversity emergent properties](#post-31).

Methodological contributions include an [R package for spatial data subdivision](#post-3), a [practical guide to Frescalo trend detection](#post-10), [chemical timber tracing](#post-17) for harvest identification, a [taxon-stratified GBIF bias-correction dataset](#post-22) for species distribution models, and a framework for [reproducible biodiversity science infrastructure](#post-19).

Community content includes a [postdoctoral position in vegetation mapping](#post-16) at the Greenland Institute of Natural Resources, a [biogeography seminar](#post-28) featuring Michael Landis, and an [Atlas of Botany book signing](#post-24).
