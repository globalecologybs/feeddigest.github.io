...
In this digest, questions of functional diversity and specialization recur across scales and systems, from molecules to landscapes. Species-age effects on [niche position and specialization in Neotropical vertebrates](#post-1) complement work mapping [plant CSR strategies across European grasslands](#post-7) under projected climate change, and scaling analyses reveal [universal patterns in functional diversity across biological and socioeconomic systems](#post-24). Chemodiversity emerges as a structuring concept, with [chemodiversity's ecological role as an emergent property](#post-32) reviewed alongside findings that [invasive Mediterranean seaweeds may functionally compensate for endemic species loss](#post-8). Climate-driven change is documented across biomes: [alpine shrubification across European mountains via GLORIA data](#post-30), [Posidonia oceanica mass flowering following 2022 Mediterranean heatwaves](#post-3), and [tree diversity reducing soil carbon temperature sensitivity through microbial stabilization](#post-12). [Metawebs as a macroecological modeling framework](#post-10), a [global bumblebee phylogeny integrating nuclear, mitochondrial and genomic data](#post-13), and [population density shaping home range size and overlap](#post-28) extend biodiversity coverage, alongside [MIREN's 20 years of mountain invasion monitoring](#post-5) and [bacterial-to-fungal richness ratios as ecosystem health indicators](#post-31). [Aquatic eDNA for global biodiversity targets](#post-2), [gut Vibrio bacteria mediating CaCO3 precipitation in toadfish](#post-27), and [LUCA's complexity informing life-origins theory](#post-22) connect molecular tools to ecosystem-scale processes. Policy dimensions include [human roles in conservation amid AI](#post-15), [cultural legacies shaping Euro-American wildlife values](#post-16), [Antarctic Treaty disaster management](#post-9), and [biological control stability in strip cropping systems](#post-26).

Methods and data contributions are substantial. The [hespdiv R package for hierarchical bioregionalization](#post-4) enables statistically testable contiguous spatial subdivision. [BIEN 4.2 for reproducible global plant biodiversity data](#post-20) integrates traits, plot records and citizen science. A [global taxon-stratified GBIF sampling-effort dataset for bias-aware SDMs](#post-23) directly addresses detectability artefacts. The [Frescalo local frequency scaling guide for trend detection with unstructured data](#post-11) and [chemical timber tracing combining multi-species wood isotope data](#post-18) address applied analytical gaps.

A [postdoctoral position at the Greenland Institute of Natural Resources](#post-17) focuses on drone-based vegetation mapping and herbivory. The [CESABINAR on intraspecific variability in tropical tree coexistence](#post-19) runs 28 May 2026. The [Funk Biogeography Seminar featuring Michael Landis](#post-29) on phylogenetic biogeography meets 27 May. The [GuardIAS and OneSTOP invasive species webinar](#post-6) is available on YouTube. The [Atlas of Botany discussion and book signing](#post-25) takes place at Royal Botanic Garden Edinburgh on 11 June. An open call for [Reviews in Marine Ecosystem Ecology: 2026](#post-14) invites synthesis papers on marine biodiversity and functioning. The [Global Ecology Bluesky starter pack Vol. 3](#post-21) has been curated, with Vol. 4 now open for contributors.
