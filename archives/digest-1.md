...
In this digest, climate-driven change across ecosystems features prominently. Coastal and marine research includes mass flowering of *Posidonia oceanica* following Mediterranean heatwaves [#post-2](#post-2), functional compensation by invasive seaweeds under warming [#post-7](#post-7), and a marine ecosystem ecology synthesis [#post-13](#post-13). Terrestrial climate findings span alpine shrubification across European mountains [#post-29](#post-29), shifting plant strategies in European grasslands [#post-6](#post-6), and tree diversity effects on soil carbon cycling via microbial pathways [#post-11](#post-11). Macroecological frameworks are well represented, covering metawebs [#post-9](#post-9), bumblebee phylogenomics [#post-12](#post-12), functional diversity scaling laws [#post-23](#post-23), home range dynamics [#post-27](#post-27), and chemodiversity [#post-31](#post-31). Freshwater eDNA informs biodiversity policy [#post-1](#post-1), while Antarctic governance [#post-8](#post-8), biological invasions [#post-5](#post-5), AI in conservation [#post-14](#post-14), wildlife values [#post-15](#post-15), and strip-cropping biological control [#post-25](#post-25) address policy and ecosystem services. Soil microbiome contributions [#post-30](#post-30), toadfish carbonate precipitation [#post-26](#post-26), and life-origin perspectives [#post-21](#post-21) round out taxonomic breadth.

Several posts address methodological and data infrastructure advances. The hespdiv R package enables hierarchical spatial subdivision [#post-3](#post-3), Frescalo scaling supports species trend detection [#post-10](#post-10), and chemical timber tracing improves harvest provenance identification [#post-17](#post-17). A taxon-stratified GBIF sampling-effort dataset targets bias-aware species distribution modelling [#post-22](#post-22), reproducible biodiversity science infrastructure is discussed [#post-19](#post-19), and global ecology synthesis volumes [#post-20](#post-20) alongside GLORIA network data underpin alpine analyses [#post-29](#post-29).

Community content includes a postdoctoral position in vegetation mapping and herbivory at the Greenland Institute of Natural Resources [#post-16](#post-16), a CESAB webinar on tropical forest traits [#post-18](#post-18), a biological invasions webinar linking OneSTOP and GuardIAS [#post-5](#post-5), the Funk Biogeography Seminar featuring Michael Landis [#post-28](#post-28), an Atlas of Botany discussion and book signing [#post-24](#post-24), and a network anniversary post [#post-4](#post-4).
