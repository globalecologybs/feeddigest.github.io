---
layout: default
title: "Global Ecology Digest from May 12, 2026 to May 26, 2026"
description: "33 curated posts from the Bluesky Global Ecology feed (May 12 - May 26, 2026): biodiversity, ecosystems, conservation -- terrestrial, freshwater & marine."
date: 2026-05-26
year: "2026"
digest_num: 1
...
# Digest from May 12, 2026 to May 26, 2026

**33 posts curated.**

In this digest, the intersection of functional diversity, climate-driven regime shifts, and spatial biodiversity frameworks is unusually prominent. Several posts converge on how climate extremes reshape community composition: [Posidonia oceanica mass flowering](#post-4) across the Mediterranean following 2022 marine heatwaves signals reproductive stress at scale, while [invasive seaweed functional compensation](#post-9) in the warming Mediterranean raises questions about whether trait redundancy can offset endemic losses. [Alpine shrubification across European mountains](#post-31), documented via the GLORIA network, parallels these thermal-boundary shifts in terrestrial systems. Trait-based and niche frameworks appear across vertebrates, grasslands, and forests: [species age and niche specialization in Neotropical vertebrates](#post-2) links evolutionary history to ecological position, [plant strategy distributions in European grasslands](#post-8) projects CSR-strategy shifts under climate change, and [tree diversity lowering soil carbon temperature sensitivity](#post-13) connects functional composition to microbial stabilization and carbon feedbacks. Microbiome contributions extend from soil [bacterial-to-fungal richness ratios as ecosystem health indicators](#post-32) to [gut Vibrio bacteria supporting CaCO3 precipitation in Gulf toadfish](#post-28), with implications for oceanic carbon cycling, and to [LUCA's evolutionary complexity and life-origins theory](#post-23). [Chemodiversity as an ecological framework](#post-33), [metawebs in macroecology and biogeography](#post-11), [bumblebee global phylogeny](#post-14), and [home range scaling with population density](#post-29) extend the functional and macroecological scope. Policy dimensions surface in calls for an [Antarctic Treaty disaster management authority](#post-10), debates on [human roles in AI-assisted conservation science](#post-16), and analysis of [cultural legacies shaping Euro-American wildlife values](#post-17). [MIREN's 20-year mountain invasion monitoring](#post-6) and [biological control stability in strip cropping systems](#post-27) broaden the applied ecological scope. The [Global Ecology Bluesky starter pack Vol. 3](#post-22) reflects growing community curation efforts.

Methods and data contributions are substantial: the [hespdiv R package](#post-5) enables hierarchical, statistically testable bioregionalization on CRAN; the [Frescalo local frequency scaling guide](#post-12) addresses species trend detection from unstructured occurrence data; the [BIEN 4.2 platform](#post-21) standardizes global plant trait, plot, and occurrence records for reproducibility; the [GBIF taxon-stratified sampling-effort dataset](#post-24) provides bias-aware backgrounds for SDMs; [aquatic eDNA for biodiversity targets](#post-3) outlines freshwater monitoring frameworks; and [chemical timber tracing combining tree genera](#post-19) improves harvest-location identification by cross-species data sharing. [Scaling laws for functional diversity across complex systems](#post-25) and [habitat fragmentation decoupling from habitat loss](#post-1) add macroecological analytical perspectives.

The [GuardIAS-OneSTOP biological invasions webinar](#post-7) is archived on YouTube. The [CESABINAR on intraspecific variability and tropical tree coexistence](#post-20) is scheduled for 28 May 2026. The [Funk Biogeography Seminar featuring Michael Landis](#post-30) on phylogenetic biogeography models runs 27 May. A [Greenland postdoctoral position in vegetation mapping and herbivory](#post-18) has an imminent deadline. The [Atlas of Botany book event](#post-26) is at Royal Botanic Garden Edinburgh on 11 June. A call for review papers on [marine ecosystem ecology synthesis 2026](#post-15) is open for submissions.
...
<p style='font-size:0.88em;color:#666;margin:-0.3em 0 0.8em 0;'>Shared by **Federico Riva** <a href='https://bsky.app/profile/rivaecology.bsky.social' target='_blank' rel='noopener'>@rivaecology.bsky.social</a> &middot; <time datetime='2026-05-25'>2026-05-25</time> &middot; 💚 3 likes on Bluesky</p>
...
<p style='font-size:0.88em;color:#666;margin:-0.3em 0 0.8em 0;'>Shared by **Carlos Calderón del Cid** <a href='https://bsky.app/profile/caldecid.bsky.social' target='_blank' rel='noopener'>@caldecid.bsky.social</a> &middot; <time datetime='2026-05-25'>2026-05-25</time> &middot; 💚 12 likes on Bluesky</p>
...
<p style='font-size:0.88em;color:#666;margin:-0.3em 0 0.8em 0;'>Shared by **Jérémy Carlot** <a href='https://bsky.app/profile/jerem-carlot.bsky.social' target='_blank' rel='noopener'>@jerem-carlot.bsky.social</a> &middot; <time datetime='2026-05-25'>2026-05-25</time> &middot; 💚 14 likes on Bluesky</p>
