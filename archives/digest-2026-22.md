...
Macroecology, marine ecology, and climate-change biology dominate this fortnight. Urban environments shape wild animal [urban boldness](#post-1), while [habitat fragmentation](#post-9) can increase or decrease independently of habitat loss, and species age predicts [Neotropical niche](#post-10) position and specialization in vertebrates. [European grasslands](#post-17) show shifting plant strategies under climate projections, and [scaling laws](#post-35) for functional diversity apply across biological and socioeconomic systems. Population density mediates [home range overlap](#post-39), and plant [chemodiversity](#post-43) plays broad ecological roles across landscapes. [Metawebs](#post-20) are synthesized as a macroecological modeling framework, and a new [bumblebee phylogeny](#post-23) integrates nuclear, mitochondrial, and genomic data. On conservation, [rewilding](#post-6), [cultural legacies](#post-27) in wildlife values, AI risks to [conservation roles](#post-26), [qualitative evaluation](#post-4) of biodiversity interventions, and [social-ecological indicators](#post-5) for area-based monitoring all received attention, alongside [strip cropping](#post-37) enhancing herbivore biocontrol and an [Antarctic governance](#post-19) call for disaster management authority. In marine systems, 2022 heatwaves triggered mass flowering of [Posidonia oceanica](#post-12), invasive [Mediterranean seaweeds](#post-18) may functionally replace endemic species, gut [Vibrio bacteria](#post-38) in Gulf toadfish may support oceanic carbonate cycling, and a [marine ecosystem](#post-25) review collection invites synthesis papers. European mountains show [alpine shrubification](#post-41) via GLORIA network data, and [mountain biodiversity](#post-13) faces broad warming threats. [Amazon corridors](#post-7) in Peru are identified as critical refugia, and [tree diversity](#post-22) lowers soil carbon temperature sensitivity through microbial stabilization. Complementing these: [Urban animals](#post-24) &middot; [Utilizing aquatic environmental](#post-11) &middot; [Origin of Life](#post-33) &middot; [beautiful birthday](#post-15) &middot; [underground census: what](#post-42).

Methods and data resources address several ecological challenges. The [hespdiv package](#post-14) automates hierarchical spatial bioregionalization in R. A [GBIF sampling-effort](#post-34) dataset enables bias-aware species distribution models globally. [BIEN 4.2](#post-31) provides reproducible plant trait, plot, and observation data across the Americas. [Frescalo scaling](#post-21) guides species trend detection from unstructured occurrence data. [Counterfactual methods](#post-2) for evaluating conservation interventions are compared systematically. [Precision ecology](#post-3) links context-specific evidence to targeted conservation action. [Chemical timber tracing](#post-29) improves harvest-location accuracy by combining multi-species wood isotope data.

Community events and opportunities are active. The [INTP seminar](#post-8) features eco-evolutionary modelling with Korinna Allhoff. A [GuardIAS webinar](#post-16) on biological invasion management is now on YouTube. A postdoc on vegetation mapping and herbivory in Greenland is advertised via the [Greenland Institute](#post-28). The [CESABINAR](#post-30) on 28 May covers intraspecific variability in tropical tree coexistence. The [Global Ecology](#post-32) Bluesky starter pack Vol. 3 is complete. Michael Landis presents phylogenetic biogeography at the [Funk Seminar](#post-40) on 27 May. The [Atlas of Botany](#post-36) hosts a discussion and signing at Royal Botanic Garden Edinburgh on 11 June.
