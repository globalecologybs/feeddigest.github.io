...
Traits, and climate-biodiversity interactions dominate this fortnight's posts. Urban environments shift behaviour across wild populations in a [urban boldness](#post-1) meta-analysis, while [home range](#post-39) size and overlap scale predictably with population density. Species age structures [niche specialization](#post-10) in Neotropical vertebrates, and [scaling laws](#post-35) for functional diversity apply broadly across biological and socioeconomic systems. [Chemodiversity](#post-43) emerges as an ecologically meaningful property, and [metawebs](#post-20) are synthesised as a macroecological modelling framework. A comprehensive [bumblebee phylogeny](#post-23) integrates nuclear, mitochondrial, and genomic data. [Habitat fragmentation](#post-9) can increase or decrease independently of habitat loss. In European grasslands, [plant strategies](#post-17) are projected to shift under climate change. On conservation and policy, [rewilding](#post-6), [cultural wildlife values](#post-27), and [AI in conservation](#post-26) receive critical attention, alongside [social-ecological indicators](#post-5) for area-based monitoring, [qualitative evaluation](#post-4) methods, and [strip cropping](#post-37) for biological pest control. Antarctica's governance gaps prompt a call for [disaster management](#post-19). In marine systems, 2022 heatwaves triggered mass flowering of [Posidonia oceanica](#post-12), invasive seaweeds may [functionally compensate](#post-18) for endemic Mediterranean algal loss, and gut [Vibrio bacteria](#post-38) in toadfish may support CaCO3 precipitation, while a [marine ecology](#post-25) review collection invites synthesis papers. European mountains show [shrubification](#post-41) and face mounting threats to [mountain biodiversity](#post-13), and Peruvian [climate corridors](#post-7) are mapped for Amazonian biodiversity. Tree diversity reduces [soil carbon](#post-22) temperature sensitivity through microbial stabilisation. Complementing these: [Urban animals](#post-24) &middot; [Utilizing aquatic environmental](#post-11) &middot; [Origin of Life](#post-33) &middot; [beautiful birthday](#post-15) &middot; [underground census: what](#post-42).

Quantitative methods and open datasets featured in this fortnight. The [hespdiv package](#post-14) automates hierarchical contiguous bioregionalisation in R. [BIEN 4.2](#post-31) standardises global plant trait, observation, and plot data for reproducible analyses. A [GBIF sampling-effort](#post-34) dataset provides taxon-stratified bias layers for species distribution models. [Frescalo](#post-21) local frequency scaling is demonstrated for trend detection with unstructured occurrence data. [Counterfactual methods](#post-2) for evaluating conservation interventions are compared systematically. [Precision ecology](#post-3) is proposed to reconcile generalised evidence with site-specific conservation context. [Timber tracing](#post-29) accuracy improves by combining wood chemical data across tree genera.

Several community opportunities are open now. The [Funk Seminar](#post-40) on May 27th features Michael Landis on phylogenetic biogeography. A [CESABINAR](#post-30) on May 28th covers intraspecific variability in tropical tree coexistence. The [GuardIAS webinar](#post-16) recording on biological invasion governance is available on YouTube. An [eco-evolutionary seminar](#post-8) featuring Korinna Allhoff is accepting discounted registrations. A [Greenland postdoc](#post-28) on vegetation mapping and herbivory has an imminent deadline. An [Atlas of Botany](#post-36) discussion and signing takes place at Royal Botanic Garden Edinburgh on June 11th. The [starter pack](#post-32) Vol. 3 for Global Ecology on Bluesky is now full, with Vol. 4 open for additions.
