...
Macroecology, climate change, and marine ecology dominate the fortnight's posts. Neotropical vertebrate niche position shifts with species age across the [Neotropics](#post-10), while [urban boldness](#post-1) differences in wild populations emerge from a global meta-analysis. Home range overlap scales with [population density](#post-39), and [functional scaling laws](#post-35) apply across biological and socioeconomic systems. [Chemodiversity](#post-43) is reviewed as an emergent ecological property shaping plant-herbivore interactions. In European [grassland strategies](#post-17), plant functional types are projected to shift under climate change, and [alpine shrubification](#post-41) is documented across European mountains using GLORIA network data. Mountain biodiversity trajectories under warming are reviewed in [montane systems](#post-13). [Habitat fragmentation](#post-9) can increase or decrease independently of habitat loss. A [metaweb framework](#post-20) synthesises food-web applications in macroecology and biogeography, and a complete [bumblebee phylogeny](#post-23) integrates nuclear, mitochondrial, and genomic data. In forests, [climate corridors](#post-7) in Peruvian Amazonia are identified as critical, and [tree diversity](#post-22) reduces soil carbon temperature sensitivity via microbial stabilisation. Marine posts cover [Posidonia oceanica](#post-12) mass flowering after 2022 Mediterranean heatwaves, [invasive seaweeds](#post-18) functionally compensating endemic losses in the warming Mediterranean, [Gulf toadfish](#post-38) gut bacteria potentially aiding calcium carbonate precipitation, and a call for [marine ecology reviews](#post-25). Conservation posts address [rewilding](#post-6), Euro-American [wildlife values](#post-27), AI in [conservation science](#post-26), [social-ecological indicators](#post-5), [qualitative evaluation](#post-4), Antarctic [disaster governance](#post-19), and [strip cropping](#post-37) biological control. Complementing these: [Urban animals](#post-24) &middot; [Utilizing aquatic environmental](#post-11) &middot; [Origin of Life](#post-33) &middot; [beautiful birthday](#post-15) &middot; [underground census: what](#post-42).

Several tools and datasets support biodiversity research. The [hespdiv package](#post-14) automates hierarchical spatial bioregionalization in R. A [Frescalo guide](#post-21) enables species trend detection from unstructured occurrence data. The [BIEN 4.2](#post-31) database provides a reproducible standard for plant traits, observations, and plot data across the Americas. A [GBIF sampling-effort](#post-34) dataset supports bias-aware species distribution models globally. [Chemical timber tracing](#post-29) improves harvest-location identification by combining multi-species wood chemistry. [Counterfactual methods](#post-2) for evaluating conservation interventions are compared systematically. A [precision ecology](#post-3) framework addresses context-dependence in evidence-based conservation.

The community section carries several opportunities and events. A [Greenland postdoc](#post-28) position focuses on vegetation mapping and herbivory using drones. The [CESABINAR](#post-30) on 28 May covers intraspecific variability in tropical tree coexistence. A [biogeography seminar](#post-40) on 27 May features Michael Landis on phylogenetic models of past distributions. The [GuardIAS webinar](#post-16) on invasive species biosecurity is now on YouTube. An [eco-evolutionary seminar](#post-8) with Korinna Allhoff is accepting discounted registrations. The [Atlas of Botany](#post-36) book signing takes place at Royal Botanic Garden Edinburgh on 11 June. A [Global Ecology](#post-32) starter pack Vol. 4 is now open for new members.
