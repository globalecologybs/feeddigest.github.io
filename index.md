...
<div style='border:1px solid #e5e5e5;border-radius:10px;padding:1.1rem 1.3rem;margin:0.6rem 0 1.1rem;background:#fafbfc;'>
  <div style='font-size:1.15rem;font-weight:700;'>Digest from May 18, 2026 to June 01, 2026</div>
  <div style='color:#666;font-size:0.92rem;margin:0.25rem 0 0.9rem;'>59 posts curated</div>
  <a href='/feeddigest.github.io/archives/digest-2026-23/' style='display:inline-block;padding:10px 18px;background:#83b27e;color:white;border-radius:6px;text-decoration:none;font-weight:600;'>Read this digest →</a>
</div>

<p><a href='/feeddigest.github.io/archives/' style='display:inline-block;padding:8px 16px;border:1px solid #83b27e;color:#83b27e;border-radius:6px;text-decoration:none;'>Browse the full archive →</a></p>
